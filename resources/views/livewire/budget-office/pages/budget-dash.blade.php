<div class="mx-auto max-w-7xl sm:px-6 lg:px-8"
    ...
    x-transition:enter-end="opacity-100">
        <div class="overflow-hidden divide-y divide-gray-500 rounded-lg shadow bg-primary-200">
            <div class="flex flex-wrap items-center justify-between px-4 py-5 sm:px-6 sm:flex-nowrap">
                ...
                <div class="flex-shrink-0 mt-2 ml-4">
                    <input type="text" id="draftssearch" placeholder="Enter tracking number" wire:model.debounce.300ms="searchPersonal"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium bg-gray-100 border rounded-md shadow-sm border-primary-700 text-primaty-bg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-400">
                </div>
            </div>
            <div class="px-4 py-5 sm:p-6">
                            ...
                            <div class="px-4 py-4 sm:px-6">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex flex-shrink-0 ml-2">
                                        ...
                                        <button x-on:click="showStatus = true; $wire.emit('dvClicked',{{$draft_dv->id}});"
                                            class="inline-flex px-3 text-xs font-semibold leading-5 text-indigo-500 bg-indigo-100 rounded-full">
                                            View voucher feed
                                        </button>
                                    </div>
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true"
        ...
        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="fixed inset-0 transition-opacity bg-opacity-75 bg-primary-700" aria-hidden="true" x-cloak
            ...
            <div x-cloak x-show="showModalForward" @click.away="showModalForward=false"
                ...
                class="inline-block px-4 pt-5 pb-4 mx-auto overflow-hidden text-left align-bottom transition-all transform rounded-lg shadow-xl bg-primary-300 max-w-7xl sm:px-6 lg:px-8 sm:my-8 sm:align-middle sm:w-full sm:p-6">
            ...
            <div x-cloak x-show="showModalReturn" @click.away="showModalReturn=false"
                ...
                <div class="max-w-full mx-auto">
                    <div class="p-10 bg-white rounded-lg">
                        <h1 class="mb-10 font-sans text-lg font-bold tracking-wider text-gray-900 drop-shadow-sm">
                            SELECT WHERE
                            ...
                            <li>
                                <div class="space-y-4 text-left">
                                    ...
                                    <button class="flex-shrink-0 block " x-on:click="showModalReturn = false"
                                        ...
                                        <div
                                            class="flex items-center rounded-lg group-hover:bg-primary-300 group-hover:bg-opacity-95 group-focus:ring-2 group-focus:ring-primary-600">
                                            <div>
                                ...
                                <div class="flex items-start justify-between">
                                    ...
                                    <div class="flex items-center ml-3 h-7">
                                        <button type="button" x-on:click="showStatus =false"
                                            class="text-white bg-transparent rounded-md hover:text-primary-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-200">
