<div class="p-0 m-0"
    x-data="{newDV : @entangle('newDV') ,isstep4open : @entangle('isstep4open') ,step1finished : @entangle('step1finished'), step2finished : @entangle('step2finished'), step3finished : @entangle('step3finished'), step4finished : @entangle('step4finished'),showToModal : @entangle('showToModal')}">
    <div class=""
        ...
        <div class="p-2">
            ...
            <div class="grid grid-cols-9 mt-4" x-data="{dvSaved : @entangle('dvSaved')}">
                <div class="justify-end col-span-3 col-start-1">
                    <button
