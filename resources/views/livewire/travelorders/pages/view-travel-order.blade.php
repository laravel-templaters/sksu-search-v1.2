            ...
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6"
                    ...
                    <div>
                        ...
                        <div class="mt-3 text-center sm:mt-5">
                          <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Travel Order Approved!</h3>
                          <div class="mt-2">
...
<div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div class="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6"
        ...
        <div>
            ...
            <div class="mt-3 text-center sm:mt-5">
              <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Travel Order Declined!</h3>
              <div class="mt-2">
                <p class="text-sm text-gray-500 uppercase">Your approval of travel order <span class="italic">{{ $travel_order->tracking_code }}</span> has been updated!</p>
                <p class="text-xs text-gray-300">This modal will close in a few seconds. Or just click away!</p>
              </div>
                ...
                <li class="py-5">
                    <div class="relative focus-within:ring-2 focus-within:ring-indigo-500">
                        ...
                        <p class="mt-1 text-sm text-gray-700 line-clamp-2">Approval from {{ $signatory->user->name }} is
                            still <strong class="text-yellow-600 uppercase italic">pending</strong>. </p>
                        @elseif ($signatory->approval_status == 'approved')
                        <p class="mt-1 text-sm text-gray-700 line-clamp-2">{{ $signatory->user->name }} has <strong
                                class="text-green-700 uppercase italic">approved</strong> of this travel order! </p>
                        @elseif ($signatory->approval_status == 'declined')
                        <p class="mt-1 text-sm text-gray-700 line-clamp-2">{{ $signatory->user->name }} has <strong
                                class="text-red-500 uppercase italic">Vetoed/declined</strong> this travel order.*See
                            side notes(if any) </p>
                        @endif
