<div class = "p-5">
        ...
        <div class="items-center mx-auto mb-5 text-center">
            <h3 class="font-sans text-4xl font-extrabold shadow-md text-primary-text drop-shadow-md">SELECT TRANSACTION</h3>
        </div>
        ...
        <li class="flex flex-col col-span-1 text-center bg-white divide-y divide-gray-200 rounded-lg shadow">
            ...
            <h3 class="my-auto text-3xl font-extrabold text-primary-text">DISBURSEMENTS</h3>
            </div>
            <div>
        ...
        <li class="flex flex-col col-span-1 text-center bg-white divide-y divide-gray-200 rounded-lg shadow">
            <div class="flex flex-col flex-1 p-8">
            <h3 class="my-auto text-3xl font-extrabold uppercase text-primary-text">Liquidation</h3>
            </div>
            <div>
            <div class="flex -mt-px divide-x divide-gray-200">
        ...
        <li class="flex flex-col col-span-1 text-center bg-white divide-y divide-gray-200 rounded-lg shadow">
            <div class="flex flex-col flex-1 p-8">
            <h3 class="my-auto text-3xl font-extrabold uppercase text-primary-text">Certificate of Availability of Funds</h3>
            </div>
            <div>
            <div class="flex -mt-px divide-x divide-gray-200">
        ...
        <li class="flex flex-col col-span-1 text-center bg-white divide-y divide-gray-200 rounded-lg shadow">
            <div class="flex flex-col flex-1 p-8">
            <h3 class="my-auto text-3xl font-extrabold uppercase text-primary-text">P.O. Certification</h3>
            </div>
            <div>
            <div class="flex -mt-px divide-x divide-gray-200">
        ...
        <li class="flex flex-col col-span-1 text-center bg-white divide-y divide-gray-200 rounded-lg shadow">
            <div class="flex flex-col flex-1 p-8">
            <h3 class="my-auto text-3xl font-extrabold uppercase text-primary-text">Certification on Personnel Records</h3>
            </div>
            <div>
            <div class="flex -mt-px divide-x divide-gray-200">
        ...
        <li class="flex flex-col col-span-1 text-center bg-white divide-y divide-gray-200 rounded-lg shadow">
            <div class="flex flex-col flex-1 p-8">
            <h3 class="my-auto text-3xl font-extrabold uppercase text-primary-text">Communication</h3>
            </div>
            <div>
            <div class="flex -mt-px divide-x divide-gray-200">
         ...
         <li class="flex flex-col col-span-1 text-center bg-white divide-y divide-gray-200 rounded-lg shadow">
            <div class="flex flex-col flex-1 p-8">
            <h3 class="my-auto text-3xl font-extrabold uppercase text-primary-text">Travel Order</h3>
            </div>
            <div>
            <div class="flex -mt-px divide-x divide-gray-200">
         ...
         <li class="flex flex-col col-span-1 text-center bg-white divide-y divide-gray-200 rounded-lg shadow">
            <div class="flex flex-col flex-1 p-8">
            <h3 class="my-auto text-3xl font-extrabold uppercase text-primary-text">Others</h3>
            </div>
            <div>
            <div class="flex -mt-px divide-x divide-gray-200">
