<div class="m-4 bg-white rounded-md">
    ...
    <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
        <div>
            ...
            <div class="mt-6 space-y-6 sm:mt-5 sm:space-y-5">
                ...
                <div class="grid items-start grid-cols-3 grid-rows-2 gap-4 pt-2 border-t border-gray-200">
                    <label for="" class="block col-span-1 col-start-1 row-span-2 font-medium text-md text-primary-bg sm:mt-px sm:pt-2">
                        Place to visit
                    </label>
        ...
        <div class ="flex mt-5">            
            ...
            <label for="date_from" class="absolute inline-block px-1 -mt-px text-xs font-medium text-gray-900 bg-white -top-2 left-2 ">From</label>
            ...
            <div class="relative px-3 py-2 border border-gray-200 rounded-md shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
            <label for="date_to" class="absolute inline-block px-1 -mt-px text-xs font-medium text-gray-900 bg-white -top-2 left-2">To</label>
    ...
    <div class="pt-8">
        ...
        <button type="submit" class="px-4 py-2 mx-2 font-bold border border-gray-300 rounded-md shadow-sm bg-primary-bg-alt text-md text-secondary-text hover:bg-gray-50 hover:text-primary-text-alt focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            Save
        </button>
        </div>
    </div>
