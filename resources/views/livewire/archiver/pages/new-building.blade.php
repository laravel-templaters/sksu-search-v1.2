                            ...
                            <div class="flex justify-between max-w-full m-4 ">
                                <div class="flex justify-start max-w-full m-4 ">
                                    ...
                                    <div x-data="{isSelected:false}">
                                         <div class="flex p-2 m-3 border-4 border-black rounded-lg group hover:cursor-pointer" :class="isSelected == true ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-900'">
